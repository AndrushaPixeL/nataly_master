  ...
  <div class="footer_wrap">
    ...
    <div class="footer_contact_wrap">
      <div class="footer_contact">
        <a target="_blank" href="https://vk.com/nanail_vrn"><svg viewBox="0 0 64 64" class="footer_link_svg">
            <g>
              <rect height="64" rx="14" ry="14" width="64" fill="#4489c8" />
              <path fill="#fff"
        ...
        <a target="_blank" href="https://instagram.com/masternail_vrn?igshid=NDk5N2NlZjQ="><svg viewBox="0 0 512 512"
            class="footer_link_svg">
            <style type="text/css">
              .st0 {
                fill: url(#SVGID_1_);
              }
            ...
            <g>
              <radialGradient cx="225.4737" cy="222.8046"
                gradientTransform="matrix(14.2175 0 0 14.2171 -3055.7039 -2615.9958)" gradientUnits="userSpaceOnUse"
                id="SVGID_1_" r="47.7212">
    ...
    <div class="footer_logo_wrap"><img class="footer_logo" src="<?php echo get_template_directory_uri() ?>/img/logo/logo.png"></div>
  </div>
